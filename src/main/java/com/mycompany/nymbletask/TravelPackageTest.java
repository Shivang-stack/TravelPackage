...
/**
 * TravelPackageTest class contains JUnit tests for the functionality of the TravelPackage and Passenger classes.
 * It tests signing up for activities, applying discounts for GoldPassenger, signing up for free for PremiumPassenger,
 * adding passengers to the travel package, adding destinations to the travel package, and creating a test travel package.
 * 
 * Author: Shivang'
 */
